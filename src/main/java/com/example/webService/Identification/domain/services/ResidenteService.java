...
public class ResidenteService { // Define la clase de servicio ResidenteService.
    ...
    public ResidenteResponseDto createIdentification(ResidenteCreateDto createDto) {
        ...
        String blockchainUrl = "https://blockchain-sercureid.netlify.app/api/residentes/registrar"; // URL del servicio de la blockchain.
    ...
    public List<ResidenteResponseDto> getAllIdentifications() {
        String blockchainUrl = "https://blockchain-sercureid.netlify.app/api/residentes"; // URL para obtener todos los residentes de la blockchain.
    ...
    public ResidenteResponseDto getIdentificationById(int id) {
        String blockchainUrl = "https://blockchain-sercureid.netlify.app/api/residentes/" + id; // URL para obtener un residente de la blockchain por su ID.
        ResponseEntity<Map> response = restTemplate.getForEntity(blockchainUrl, Map.class); // Realiza la solicitud GET a la blockchain.
    ...
    public ResidenteResponseDto loginByIdDigital(String idDigital) {
        String blockchainUrl = "https://blockchain-sercureid.netlify.app/api/residentes/login"; // URL para hacer login con el ID digital.
